...
class NitromathRacer:
    ...
    async def get_gold_data(self):
        resp = self._scraper.post('https://www.nitrotype.com/api/v2/payments/products/', data={'username': self.username, 'type': 'gold'})
    ...
    def _initialize_attributes(self):
        ...
        if trail:
            ...
            self.trail_img = f"https://www.nitrotype.com{trail['options']['src']}"
        else:
